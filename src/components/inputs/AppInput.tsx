      ...
      <div className="relative w-full">
        ...
        {props.type === "textarea" ? (
          ...
          <input
            ...
            maxLength={props.maxLength}
            // className="border border-gray-300 appearance-none rounded w-full py-2 px-3 h-10 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-sidebar pr-10"
            // className="w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300"
            className="w-full pl-2 pr-2 py-2 border rounded-lg bg-[var(--input-bg)] text-[var(--foreground)] border-[var(--border)] focus:outline-none focus:ring-1 focus:ring-[var(--primary)] transition-shadow"
            placeholder={props.placeHolder}
          />
        )}
